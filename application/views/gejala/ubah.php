<div class="page-wrapper">
	...
	<div class="container-fluid">
		<div class="card">
			<div class="card-body">
				<form class="mt-4" action="<?= base_url('gejala/update/') . $gejala['id'] ?>" method="POST">
					<h5 class="card-title">Kode Gejala</h5>
					<div class="form-group">
						<input type="text" class="form-control col-sm-1" name="kode" id="kode" value="<?= $gejala['kode']; ?>" readonly>
					</div>
